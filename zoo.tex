...
\begin{tcbraster}[raster columns=5, 
	...
	\tcbox[blankest,
		...
		raster multirow=2]{
			\begin{tikzpicture}
				...
				\cultnode{(3,0)}{vulture}{20}
			\end{tikzpicture}
			Farmer and Jornalero Residence:\\
			+10\% workforce\\
		...
		\tcbox[nodebox, %Luminaries
			...
			\begin{tikzpicture}
				...
				\cultnode{(3,0)}{Luminescent_Fish}{30}
			\end{tikzpicture}
			+3\smallicon{Attractiveness} from Pubs, Variety Theatres, Members Clubs, Shopping Arcades and Restaurants
		}
		...
		raster multirow=2]{
			\begin{tikzpicture}
				...
				\cultnode{(3,0)}{swordfish}{30}
			\end{tikzpicture}
			All Coastal Buildings:\\
			+10\% productivity\\
			-10\%\smallicon{balance}\\
			-5\% workforce.
		}		
	...
	raster multirow=3]{
		\begin{tikzpicture}
			...
			\cultnode{(3,0)}{eastern_elephant}{40}
