...
\newcommand{\venue}[5]{
	\consstratalist{#5}
	\node[outer ysep=\nodepadding,
	label={[label distance=\lblmrkdist]\facnumdegs:},
	hyperlink node=\thewiki/wiki/#4] (#2) at #1 {
		\begin{tikzpicture}
			\node[outer ysep=\nodepadding] at (0,0) {\icon{#3}}; %TODO change icon to #2 when available
			\matrix[inner sep=2pt,
			row sep=-2pt,
			column sep=-1mm,
			matrix of nodes,
...
\newcommand{\restrecipe}[3]{ \venue{#1}{#2}{Restaurant}{Restaurant}{#3} }
\newcommand{\barrecipe}[3]{ \venue{#1}{#2}{Bar}{Bar}{#3} }
\newcommand{\caferecipe}[3]{ \venue{#1}{#2}{Cafe}{Cafe}{#3} }
\newcommand{\drugpatent}[3]{ \venue{#1}{#2}{Drug_Store}{Drug_Store}{#3} }
\newcommand{\deppatent}[3]{ \venue{#1}{#2}{Department_Store}{Department_Store}{#3} }
\newcommand{\furpatent}[3]{ \venue{#1}{#2}{Furniture_Store}{Furniture_Store}{#3} }
...
\begin{tcbraster}[raster columns=\portraitraster,
    ...
    \tcbox[nodebox, % Rum
        ...
        \begin{tikzpicture}
            ...
            \consnode{(2,-0.75)}{Rum}{2}{Rum_Distillery}{Artisans/1050,Engineers/700,Jornaleros/1400,Obreros/1400,Scholars/10000}
