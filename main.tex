...
\begin{tcbraster}[raster columns=7,
    ...
    \tcbox[raster multicolumn=3, % Oil Lamps
        ...
        \begin{tikzpicture}
            ...
            \consnode{(4,-1.5)}{Oil_Lamps}{2}{Oil_Lamp_Factory}{Explorers/3333,Technicians/3333}
...
\begin{tcbraster}[raster columns=5,
    ...
    \tcbox[raster multicolumn=2, % Parkas
        ...
        \begin{tikzpicture}
            ...
            \consnode{(2,-0.75)}{Parkas}{3}{Parka_Factory}{Technicians/1666}
   ...
   \tcbox[raster multicolumn=3, % Husky Sleds
        ...
        \begin{tikzpicture}
            ...
            \consnode{(4,-1.5)}{Husky_Sleds}{4}{Husky_Sled_Factory}{Technicians/4444}
