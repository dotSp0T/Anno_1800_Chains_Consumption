...
\newcommand{\cultnode}[3]{
	\node[outer ysep=\nodepadding,
	label={[label distance=\lblmrkdist]\lblmrkdegs:\textcolor{olive}{#3}}]
	 (#2) at #1 {\icon{#2}};
}
...
\newcommand{\cultnodelbld}[4]{
	\node[outer ysep=\nodepadding,
	label={[label distance=\lblmrkdist]\lblmrkdegs:\textcolor{olive}{#3}\smallicon{music_score_#4}}]
	(#2) at #1 {\icon{#2}};
}
...
\begin{tcbraster}[raster columns=5,
    ...
    \tcbox[nodebox, % Work Clothes
           ...
           raster multirow=2]{
        \begin{tikzpicture}
            \farmnodec{(0,0)}{Wool}{1}{Sheep_Farm}{3×3}{3}{Artisans/33.3/2/0/0}
            \consnode{(3,0)}{Work_clothes}{1}{Framework_Knitters}{Farmers/65/2/0/3,Workers/32.5/2/0/6,Jornaleros/50/3/0/0.5}
