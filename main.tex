...
\begin{tcbraster}[raster columns=\portraitraster,
    ...
    \tcbox[nodebox, % Canned Food
        ...
        \begin{tikzpicture}
            ...
            \consnode{(5.5,-1.5)}{Canned_food}{6}{Cannery}{Artisans/1950,Engineers/1300,Technicians/1111}
        ...
        \begin{tcbraster}[raster height=\boxheight,
            ...
            \tcbox[nodebox, % Gramophones
                ...
                \begin{tikzpicture}
                    ...
                    \consnodefe{(4,-1.5)}{Gramophone}{4}{Gramophone_Factory}{Investors/9500}
...
\begin{tcbraster}[raster columns=8,
    ...
    \tcbox[nodebox, % Bowler Hats
        ...
        \begin{tikzpicture}
            ...
            \consnode{(4,-0.75)}{Bowler_hats}{1}{Bombin_Weaver}{Obreros/1500}
