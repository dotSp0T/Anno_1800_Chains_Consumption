...
\begin{tcbraster}[raster columns=\portraitraster,
    ...
    \tcbox[nodebox, % Canned Food
        ...
        \begin{tikzpicture}
            ...
            \consnode{(4,-1.5)}{Canned_food}{6}{Cannery}{Artisans/1950,Engineers/1300,Technicians/1111}
...
\begin{tcbraster}[raster columns=7,
    ...
    \tcbox[raster multicolumn=3, % Oil Lamps
        ...
        \begin{tikzpicture}
            ...
            \prodnode{(2,-3)}{Whale_Oil}{2}{Whaling_Station}
...
\begin{tcbraster}[raster columns=5,
    ...
    \tcbox[raster multicolumn=2, % Parkas
        ...
        \end{tikzpicture}}
   \tcbox[raster multicolumn=3, % Husky Sleds
           raster multirow=3]{
        \begin{tikzpicture}
