...
\newcommand{\oldworld}{\circled{O}}
\newcommand{\newworld}{\circled{N}}
\newcommand{\arctic}{\circled{A}}
...
\begin{tcbraster}[raster columns=\portraitraster,
    ...
    \tcbox[nodebox, % Fur Coats
        ...
        \begin{tikzpicture}
            ...
            \consnode{(4,-0.75)}{Fur_Coats}{2}{Fur_Dealer}{Artisans/2250,Engineers/1500}
...
\\
Some buildings have variants with different statistics, these are markes with \oldworld{}, \newworld{} and \arctic{} for the Old World, New World and Arctic respectively.
\\
